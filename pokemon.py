...
class Pokemon:
    def __init__(self, id, level=1, nickname=''):
        self.p_name = Pokedex[id]['Name']

        self.type = Pokedex[id]['Type']
        self.ability = Pokedex[id]['Ability']
        self.evolve_lv = Pokedex[id]['Evolve_Lv']
        self.evolve_to = Pokedex[id]['Evolve_To']
